...
(function () {
  const projectData = [
    ...
    },
    {
      ...
      description: "Checklist application built using React Framework",
    ...
    },
    {
      ...
      description:
        "Ruby on Rails project modeled after the popular Basecamp program. It is deployed in Heroku. The project has a database, a backend, and a frontend. My main contribution was implementing user authentication, attachments, discussions, comments, and user permissions.",
